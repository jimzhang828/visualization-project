...
function drawCareer() {
    ...
    const select_statement = 'SELECT * WHERE A = "Chiang Lai Wan" OR A = "Leung Mei Fun" OR A = "Mo Man Ching Claudia" OR A = "Wong Pik Wan Helena"';
...
function drawInvestigate() {
    ...
    query_statement += encodeURIComponent('SELECT * WHERE A = "Chiang Lai Wan" OR A = "Leung Mei Fun" OR A = "Mo Man Ching Claudia" OR A = "Wong Pik Wan Helena"');
